...
const CommunityReportForm = () => {
  ...
  const loadReport = async () => {
    try {
      ...
      if (response.success) {
        ...
        setFormData({
          ...
          location: {
            ...
            coordinates: report.location?.coordinates || { latitude: null, longitude: null }
          },
          affectedPopulation: report.affectedPopulation || '',
          immediateActions: report.immediateActions || false,
      ...
      navigate('/app/community-reports');
    } finally {
  ...
  const validateForm = () => {
    ...
    if (!formData.reportType) errors.push('Report type is required');
    if (!formData.issueDescription.trim()) errors.push('Description is required');
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate('/app/community-reports')}
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <input
                    ...
                    checked={formData.immediateActions}
                    onChange={handleInputChange}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                  <label htmlFor="immediateActions" className="text-sm font-medium text-gray-700">
